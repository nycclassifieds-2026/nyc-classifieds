...
export const categories: Category[] = [
  ...
  { name: 'Community', slug: 'community', color: '#059669', tagline: 'The Porch | Local Feed', subs: ['Carpool & Rideshare', 'Events', 'Garage Sales', 'Groups', 'Local Alerts', 'Lost & Found', 'Neighborhood Questions', 'Pet Sightings', 'Recommendations', 'Stoop Sales', 'Volunteers', 'Welcome / New Here'] },
...
export const boroughs: Borough[] = [
  ...
  { name: 'Bronx', slug: 'bronx', neighborhoods: ['Belmont','Concourse','Fordham','Highbridge','Hunts Point','Kingsbridge','Morris Park','Mott Haven','Norwood','Pelham Bay','Riverdale','South Bronx','Throgs Neck','Tremont','Wakefield'] },
